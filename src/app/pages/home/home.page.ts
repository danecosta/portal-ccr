...
export class HomePage {
  ...
  cards: any[] = [
    { titulo: 'Comunicados', destino: 'comunicados', descricao: 'Fique sempre por dentro do que acontece na CCR!', icone: 'megaphone-outline' },
    ...
    { titulo: 'Postos de Combustível', destino: 'postos-combustivel', descricao: '', icone: 'speedometer-outline' },
    { titulo: 'Emergência', destino: 'emergencia', descricao: '', icone: 'call-outline' },
  ];
